...
const CTAButton = ({ children }: { children: React.ReactNode }) => {
  return (
    <Link
      to="projects"
      smooth
      className={`${lato.className} hover:text-viceCyan group relative mt-10 cursor-pointer bg-black px-4 py-2 text-xl font-bold uppercase text-white underline-offset-8 transition-all duration-200 hover:underline`}
    >
